...
public class Keybinds {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (pressed && clientAnchor != null && mc.player.hasEffect(org.example.shrimpo.solphyte.registry.SolphyteEffect.STRINGING.get())) {
            ...
            if (dist > 1e-3) {
                ...
                clientRopeLen = Math.max(org.example.shrimpo.solphyte.Config.grMinDistance, clientRopeLen - reelRate);
    ...
    private static Vec3 tryStart(Player player, Level level) {
        ...
        double maxRange = org.example.shrimpo.solphyte.Config.grMaxAnchorDistance; // configurable
        ...
        double hitRadius = Math.max(1.0, org.example.shrimpo.solphyte.Config.grNodeHitRadius);
        ...
        if (nodeHit != null) {
            ...
            double snapR = Math.max(1.25, org.example.shrimpo.solphyte.Config.grSnapRadius);
        ...
        clientRopeLen = Math.max(org.example.shrimpo.solphyte.Config.grMinDistance, startDist + org.example.shrimpo.solphyte.Config.grStartSlack);
