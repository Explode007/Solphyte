package org.example.shrimpo.solphyte.menu;
...
import org.example.shrimpo.solphyte.registry.SolphyteMenu;
    ...
    public PhytoAlteratorMenu(int id, Inventory playerInv, Container container, BlockPos pos) {
        ...
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 3; col++) {
                this.addSlot(new Slot(container, row * 3 + col, startX + col * 18, startY + row * 18));
            }
        }
